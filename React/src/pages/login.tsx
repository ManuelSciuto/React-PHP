        ...
        <div>
            <div className="w-1/2 rounded-lg mt-5 mx-auto border-2 max-w-md">
                ...
                <form className="w-full p-3 -mt-3 bg-white rounded-md">
                    ...
                    <div className="mt-2">
                        <label className="block pl-px mb-0.5 text-sm font-medium text-gray-900">Password</label>
                        <input type="password"
                               onChange={(e) => setPassword(e.target.value)}
                               className="bg-gray-200 hover:bg-[rgb(219,222,227)] border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2"
                               required={true}/>
                    </div>
                    <div onClick={() => setRicordami(!ricordami)} className="flex mt-2 pl-px items-center gap-x-1 text-lg font-medium">
                        <input type="checkbox" onChange={() => {}} checked={ricordami} className="scale-125"/>
